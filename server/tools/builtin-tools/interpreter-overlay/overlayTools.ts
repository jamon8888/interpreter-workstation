          ...
          oneOf: [
            {
              ...
              properties: {
                ...
                server_id: {
                  type: 'string',
                  description: 'Exact realtime-compatible Hacienda builtin server id.',
                },
                tool_name: {
                  type: 'string',
                  description: 'Exact realtime-compatible Hacienda builtin tool name.',
                },
                arguments: {
                  type: 'object',
